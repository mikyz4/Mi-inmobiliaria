    ...
    if (chatContainer) {
        ...
        const subscribeToMessages = () => {
            ...
            messagesSubscription = supabaseClient.channel(`messages_for_${conversationId}`)
                .on('postgres_changes', { 
                    ...
                    // Solo mostramos el mensaje si no lo hemos enviado nosotros
                ...
                .subscribe((status) => {
                    if (status === 'SUBSCRIBED') {
                        console.log('Conectado al canal de mensajes en tiempo real.');
                    }
                });
        };
        ...
        messageForm.addEventListener('submit', async (e) => {
            ...
            if (error) {
                ...
                // El mensaje enviado ya debería aparecer por la suscripción en tiempo real
